...
import type { ExternalBlob as _ExternalBlob, UserProfile as _UserProfile, UserRole as _UserRole, VideoEntry as _VideoEntry, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createVideoEntry(arg0: string, arg1: VideoEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.createVideoEntry(arg0, await to_candid_VideoEntry_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async deleteVideoEntry(arg0: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAllVideoEntriesSortedByAnimeName(): Promise<Array<VideoEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllVideoEntriesSortedByAnimeName();
    ...
    async getPublishedVideoEntries(): Promise<Array<VideoEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getPublishedVideoEntries();
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideoAsset(arg0: string): Promise<ExternalBlob> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoAsset(arg0);
    ...
    async getVideoEntriesByCategory(arg0: string): Promise<Array<VideoEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoEntriesByCategory(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getVideoEntry(arg0: string): Promise<VideoEntry> {
        if (this.processError) {
            try {
                const result = await this.actor.getVideoEntry(arg0);
                return from_candid_VideoEntry_n14(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async searchByAnimeName(arg0: string): Promise<Array<VideoEntry>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchByAnimeName(arg0);
                return from_candid_vec_n13(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateVideoEntry(arg0: string, arg1: VideoEntry): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateVideoEntry(arg0, await to_candid_VideoEntry_n10(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_VideoEntry_n14(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _VideoEntry): Promise<VideoEntry> {
...
async function from_candid_record_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        asset: await from_candid_ExternalBlob_n16(_uploadFile, _downloadFile, value.asset),
...
async function from_candid_vec_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_VideoEntry>): Promise<Array<VideoEntry>> {
    return await Promise.all(value.map(async (x)=>await from_candid_VideoEntry_n14(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_VideoEntry_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: VideoEntry): Promise<_VideoEntry> {
...
async function to_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        title: value.title,
        asset: await to_candid_ExternalBlob_n12(_uploadFile, _downloadFile, value.asset),
        isPublished: value.isPublished,
        description: value.description,
        animeName: value.animeName,
        category: value.category
